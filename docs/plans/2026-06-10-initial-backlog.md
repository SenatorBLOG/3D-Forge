...
| M4 | Edit pipeline + version history: send spatial prompt for a localized edit, save model versions, version switcher UI | Mikhail (Javid inactive) | 🔄 in progress ([plan](2026-06-12-m4-history.md)) |
